...
function About() {
  return (
    <div className="pb-24 pt-40 md:pt-48">
      ...
      <section className="mt-24 border-t border-ink/10 px-6 py-24 md:px-12">
        <h2 className="mb-16 font-display text-3xl font-semibold uppercase tracking-tighter md:text-4xl">
        ...
        <div className="border-t border-ink/10">
          {experience.map((item) => (
            ...
            >
              <span className="text-xs font-medium uppercase tracking-widest text-accent md:col-span-3">
                {item.period}
              </span>
      ...
      <section className="bg-ink px-6 py-24 text-paper md:px-12">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-12">
          <h2 className="font-display text-4xl font-semibold uppercase leading-[0.9] tracking-tighter md:col-span-5 md:text-6xl">
            What I <br /> work with
          </h2>
